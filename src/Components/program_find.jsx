    ...
    <section className="centers-strip">
      <div className="Program_finds">
        <div className="section-title">
          <h2 style={{ color:"#198751", margin: 0,marginLeft: "120px" }}>Find Programs &gt; &gt; &gt;</h2>
          <button style={{ background: "#fff", borderRadius: 20, padding: "8px 12px" ,marginRight:"110px"}}>View More
          ...
          <div className="centers-row" ref={scrollRef} aria-live="polite">
            {programs.map((c) => (
              <div key={c.id} className="center-card">
                <img src={c.image || ""} alt={c.name} style={{ width: "100%", height: 120, objectFit: "cover", borderRadius: 8 }} />
