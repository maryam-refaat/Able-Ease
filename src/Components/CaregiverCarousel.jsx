 ...
 * - onContact: callback function when contact button is clicked
 */
    ...
    <div className="caregiver-carousel-root" aria-roledescription="carousel">
      ...
      <div className="caregiver-carousel-track">
        {windowItems.map((care) => (
          <div
            key={care.id ?? care.ID ?? care.name}
            className="caregiver-carousel-item"
          >
            <CaregiverCard care={care} onContact={onContact} />
          </div>
        ))}
      </div>
