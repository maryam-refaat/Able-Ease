...
const API_BASE_URL = "https://ableeaseapi.runasp.net";
...
const PatientStatisticsCard = ({ data }) => {
  if (!data)
    return <div className="skeleton-card" style={{ height: "420px" }}></div>;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {data.averageAge}{" "}
            <span style={{ fontSize: "16px", fontWeight: "500" }}>yrs</span>
          </p>
        </div>
        <div
          style={{
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {data.averagePatientsPerCaregiver}
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            {data.caregiversWithZeroPatients}
          </p>
        </div>
      </div>
...
const PaymentStatisticsCard = ({ data }) => {
  ...
  const timeSeriesData = [
    {
      period: "This Month",
      payments: data.paymentsThisMonth,
      amount: data.totalAmountThisMonth,
    },
    {
      period: "This Year",
      payments: data.paymentsThisYear,
      amount: data.totalAmountThisYear,
    },
    {
      period: "All Time",
      payments: data.totalPaymentsAllTime,
    ...
    >
      ...
      >
        <span style={{ color: COLORS.success }}>
          ✓ Approved: {data.approvedPayments}
        </span>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {data.averagePatientsPerProgram}
          </p>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {data.averageReportsPerCaregiver}
          </p>
        </div>
        <div
          style={{
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {data.averageProgramsPerOrganization}
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            {data.averageCaregiversPerOrganization}
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            {data.totalFinancialAidsProvided}
          </p>
        </div>
      </div>
      ...
      {data.organizationsWithNoPrograms > 0 && (
        ...
        >
          ...
          >
            Organizations with No Programs
          </p>
          <span
            style={{
              background: COLORS.warning,
  ...
  if (rows.length === 0) {
    return (
      ...
      >
        ...
        >
          {data._failed
            ? "Failed to load Caregiver Performance data"
            : "No Caregiver Performance Data"}
        </p>
        <p style={{ fontSize: "14px", color: COLORS.textMuted }}>
          {data._failed
            ? "An error occurred while fetching this report. Check console for details."
            : "There are currently no caregiver performance records to display."}
        </p>
        {data && (
          <details
            style={{
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tfoot>
            ...
            >
              ...
              <td style={tableFooterStyle}>{summary?.totalPatients ?? 0}</td>
              <td style={tableFooterStyle}>{summary?.totalReports ?? 0}</td>
...
const FinancialAidByOrgTable = ({ data }) => {
  ...
  if (rows.length === 0) {
    return (
      ...
      >
        ...
        >
          {data._failed
            ? "Failed to load Financial Aid data"
            : "No Financial Aid Data"}
        </p>
        <p style={{ fontSize: "14px", color: COLORS.textMuted }}>
          {data._failed
            ? "An error occurred while fetching this report. Check console for details."
            : "There are currently no financial aid records to display."}
        </p>
        {data && (
          <details
            style={{
  ...
  const getStatusColor = (status) => {
    ...
    if (statusStr.includes("approved") || statusStr === "1")
      return COLORS.success;
    if (statusStr.includes("pending") || statusStr === "0")
      return COLORS.warning;
    if (statusStr.includes("rejected") || statusStr === "2")
            ...
            {data.rows.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={tableCellStyle}>{row.patientName || "N/A"}</td>
                  <td style={tableCellStyle}>
                    {formatDate(enrollDate) || "N/A"}
                  </td>
                  <td style={tableCellStyle}>
                    <span
                      style={{
                  ...
                  <td style={tableCellStyle}>{row.caregiverName || "N/A"}</td>
                </tr>
              );
            })}
          </tbody>
...
const ReportsDashboard = () => {
  ...
  const [patientProgramEnrollment, setPatientProgramEnrollment] =
    useState(null);
  ...
  const loadManagerialReports = async () => {
    ...
    try {
      ...
      setError(
        "Failed to load managerial reports. Please check your API connection."
      );
    } finally {
      setLoading(false);
    }
  ...
  const loadDetailedReports = async () => {
    ...
    try {
      ...
      setError(
        "Failed to load detailed reports. Please check your API connection."
      );
      setCaregiverPerformance({
        rows: [],
        summary: {},
        generatedAt: null,
        _failed: true,
      });
      setFinancialAidByOrg({
        rows: [],
        summary: {},
        generatedAt: null,
        _failed: true,
      });
      setPatientProgramEnrollment({
        rows: [],
        summary: {},
        generatedAt: null,
        _failed: true,
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          >
            ...
            <div>
              ...
              >
                Comprehensive analytics and insights for better healthcare
                management
              </p>
            </div>
          </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: COLORS.textMuted }}>
                  Managerial & Detailed reports shown below
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              {caregiverPerformance && (
                <CaregiverPerformanceTable data={caregiverPerformance} />
              )}
              {financialAidByOrg && (
                <FinancialAidByOrgTable data={financialAidByOrg} />
              )}
              {patientProgramEnrollment && (
                <PatientProgramEnrollmentTable
                  data={patientProgramEnrollment}
                />
              )}
